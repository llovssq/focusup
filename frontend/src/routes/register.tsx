...
function RegisterPage() {
  ...
  const handleGoogleLogin = async () => {
    if (!firstName || !lastName) {
      toast.error("Please enter your First and Last name before signing in with Google.");
      return;
    }
    ...
    <div className="dark" style={{ colorScheme: "dark" }}>
      ...
      <style>{`
        ...
        @media (max-width: 768px) {
          ...
          .reg-name-row { flex-direction: column !important; gap: 14px !important; }
        }
      `}</style>
      {/* ── PAGE SHELL ── */}
      <div
        ...
        >
          <div style={{ width: "100%", maxWidth: "440px", margin: "0 auto" }}>
            ...
            >
              ...
              <div className="reg-name-row" style={{ display: "flex", gap: 12 }}>
                <InputField
                  id="reg-first-name"
